...
const DEFAULT_ACCOUNTS = [
  ...
  { code: ACCOUNTS.FIXED_ASSET_DISPOSAL_GAIN, name: 'Gain on Fixed Asset Disposal', type: 'revenue', group: 'Other Income' },
  ...
  { code: ACCOUNTS.FIXED_ASSET_DISPOSAL_LOSS, name: 'Loss on Fixed Asset Disposal', type: 'expense', group: 'Operating Expenses' },
